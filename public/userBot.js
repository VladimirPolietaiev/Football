...
function getPlayerMove(data) {
    ...
    var RIGHT_SIDE = data.yourTeam.type === "guest";
    UPPERPLAYER_TICK = data.playerIndex === 0;
    GOALKEEPER_TICK = data.playerIndex === 1;
    LOWPLAYER_TICK = data.playerIndex === 2;

    //check side
    if (data.yourTeam.type === "home") {
        console.log("LEFT_SIDE ", data.yourTeam.type);
        return runLeftSideCode (data);
    } else if(data.yourTeam.type === "guest"){
        console.log("RIGHT_SIDE ", data.yourTeam.type);
